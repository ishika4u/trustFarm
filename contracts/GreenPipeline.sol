...
contract GreenPipeline {
    ...
    ISuperToken public trustFarmToken;
    ISuperfluidToken public trustFarmFluidToken;

    mapping(address => bool) public accountList;

    constructor(
        ISuperfluid _host,
        ISuperToken _trustFarmToken,
        ISuperfluidToken _trustFarmFluidToken,
        address _owner
    ) {
        // Ensure _trustFarmToken is indeed a super token
        require(address(_host) == _trustFarmToken.getHost(), "!superToken");

        owner = _owner;
        trustFarmToken = _trustFarmToken;
        trustFarmFluidToken = _trustFarmFluidToken;
    ...
    function sendLumpSumToContract(uint256 amount) external {
        ...
        trustFarmToken.transferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdrawFunds(uint256 amount) external {
        ...
        trustFarmToken.transfer(msg.sender, amount);
    }

    function getBalance() external view returns (uint256) {
        return trustFarmToken.balanceOf(address(this));
    }
    ...
    function deleteFlowIntoContract() external {
        ...
        cfaV1.deleteFlow(msg.sender, address(this), trustFarmFluidToken);
    }
    ...
    function createFlowFromContract(address receiver, int96 flowRate) external {
        ...
        cfaV1.createFlow(receiver, trustFarmFluidToken, flowRate);
    }
        ...
        external
    {
        ...
        cfaV1.updateFlow(receiver, trustFarmFluidToken, newFlowRate);
    }
    ...
    function deleteFlowFromContract(address receiver) external {
        ...
        cfaV1.deleteFlow(address(this), receiver, trustFarmFluidToken);
    }
    ...
    /// @notice Takes the entire balance of the designated trustFarmToken in the contract and distributes it out to unit holders w/ IDA
    ...
    function addStakeholder(
        ...
        if (!cropRewards[cropToRewardId[_cropId]].isValid) {
            ...
            idaV1.createIndex(trustFarmToken, numCropRewards);
        }
